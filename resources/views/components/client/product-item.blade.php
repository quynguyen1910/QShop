...
<div class="col-md-6 col-lg-4 col-xl-3">
    <div class="card product-item" style="width: 17rem;">
        <a class="product-item-image">
            <img src="{{ config('cloudinary.base_url') . $product->anh_sp ?? config('cloudinary.default_image') }}" class="card-img-top img-fluid product-img" alt="{{ $product->slug }}">
        </a>
        ...
        <div class="card-body d-flex gap-2 justify-content-evenly">
            <button data-id="{{ $product->id }}" href="#" class="product-item-add">
                Thêm vào
                <img class="cart-fly-img" style="height: 30px;width: 30px" src="{{asset('images/cart_fly.png')}}" alt="">
