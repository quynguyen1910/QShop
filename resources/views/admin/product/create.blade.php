...
@section('main')
    <div class="row">
        ...
        <div class="m-auto shadow p-3 mt-3">
            <h1 class="text-uppercase text-center">Tạo sản phẩm mới</h1>
            @if ($errors->any())
            ...
            @endif
            <hr>
            <form enctype="multipart/form-data" class="product-form" method="POST" action="{{ route('admin.product.store') }}">
                @csrf
                <div>
                    <div class="mb-3 text-capitalize">
                        <label for="ten_sp" class="form-label">Tên Sản Phẩm</label>
                        <input value="{{ old('ten_sp') }}" type="text" class="form-control" id="ten_sp" name="ten_sp"
                    ...
                    <div class="d-flex gap-3">
                        <div class="mb-3 text-capitalize w-100">
                            <label for="gia_sp" class="form-label">Giá Sản Phẩm</label>
                            <input value="{{ old('gia_sp') }}" type="number" class="form-control" id="gia_sp" name="gia_sp"
                        ...
                        <div class="mb-3 text-capitalize w-100">
                            ...
                            <input value="{{ old('giakm_sp') }}" type="number" class="form-control" id="giakm_sp" name="giakm_sp"
                    ...
                    <div class="mb-3 text-capitalize">
                        ...
                        <input value="{{ old('soluong_sp') }}" type="number" class="form-control" id="soluong_sp"
                    ...
                    <div class="mb-3 text-capitalize">
                        ...
                        <input value="{{ old('phukien_sp') ?? 'Tai nghe, sạc nhanh (theo máy)' }}" type="text"
                    ...
                    <div class="mb-3 text-capitalize">
                        ...
                        <input value="{{ old('khuyemai_sp') }}" type="text" class="form-control" id="khuyemai_sp"
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="mb-3 text-capitalize">
                        ...
                        <div class="preview-image">
                            <img src="https://res.cloudinary.com/dtbzvmb6r/image/upload/v1713000682/products/preview-phone.png"
                    ...
                    <div class="mb-3 text-capitalize">
                        ...
                        <textarea class="form-control" id="content" name="mota_sp"></textarea>
                        <script>
